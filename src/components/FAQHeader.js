...
const FAQHeader = () => {
  const [faqs, setfaqs] = React.useState([
    ...
    {
      number: 2,
      question: "Why is my $BakaedCake token balance reducing?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Due to the nature of the protocol, the price of the coin rebases every 8 hours to the pegged price. If you are holding $BakedCake token in your wallet, you will notice them fluctuating after a rebase. The protocol is designed for token supply to change without the holders having to do anything. ",
      open: false,
    },
  ]);
