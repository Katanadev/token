...
const HomePage = () => {
  ...
  try {
    ...
    async function getPrice() {
      request('GET', "https://api.pancakeswap.info/api/v2/tokens/0x3629618f2fcec1f79db01721faff1f55abd0d31d")
        .then((r1) => {
    ...
    async function getCsupply() {
      // fetch(
      //   "https://api.bscscan.com/api?module=account&action=state&contractaddress=0x3629618f2fcec1f79db01721faff1f55abd0d31d&address=0x000000000000000000000000000000000000dEaD&tag=latest&apikey=ADDAD8PZK7VYIEJ93GIABHS6WIXBG8UCT4"
      // )
      ...
      const contract = new web3.eth.Contract(ABI, '0x3629618f2fcec1f79db01721faff1f55abd0d31d');
    ...
    var apikey = { key: 'ADDAD8PZK7VYIEJ93GIABHS6WIXBG8UCT4' } // BSCSCAN API KEY
              ...
              <div className="row">
                <div className="col-xl-8">
                  <div className="banner-content">
                    <h1 className="mb-2">$BakedCake Token</h1>
                    <p className="mb-60">
                      <span>
                    ...
                    <div className="banner-button">
                      ...
                      <div className="banner-socials footer-socials">
                        <a
                          target="_blank"
                          rel="noopener noreferrer"
                          href="https://t.me/BakedCakeBEP20"
                        >
                ...
                <div className="col-xl-4">
                  <div className="d-none d-xl-block">
                    <div className="banner-cover">
                      <BouncyDiv></BouncyDiv>
                      <CoverTop src="https://raw.githubusercontent.com/Daddy-Honeypot/Images/acb2f3966fe0718fb27b994eb891794a9dbc486f/Farming.png" />
                      <CoverBottom src="https://raw.githubusercontent.com/Daddy-Honeypot/Images/main/Nft.png" />
                      <CoverRight src="https://raw.githubusercontent.com/Daddy-Honeypot/Images/main/Staking1.png" />
                      <CoverLeft src="https://raw.githubusercontent.com/Daddy-Honeypot/Images/main/Lottery.png" />
                    </div>
                  </div>
                </div>
              </div>
