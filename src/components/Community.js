...
const Community = () => {
  ...
  const telegramUrl = `https://t.me/BakedCakeBEP20`;

  const twitterUrl = `https://twitter.com/BakedCakeBEP20`;
              ...
              <div className="row justify-content-center">
                <div className="col-xl-12">
                  <div className="section-heading text-center mb-70">
                    ...
                    >
                      $BakedCake Official Channels
                    </h2>
                    <p>Join to Follow $BakedCake Latest News!</p>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div className="col-xl-8 col-lg-8">
                  <div className="community-main-content">
                    <a
                      target="_blank"
                      href="https://twitter.com/BakedCakeBEP20"
                      className="link-text"
                    >
                      {twitterUrl}
                    </a>
              ...
              <div className="row community-tg-list wow fadeInUp">
                <div className="col-xl-4 col-lg-4">
                  ...
                  >
                    ...
                    <div className="tg-info">
                      ...
                      <div className="tg-url">https://t.me/BakedCakeBEP20</div>
                    </div>
                  </a>
                </div>
                ...
                {/* <div className="col-xl-4 col-lg-4">
                  ...
                  >
                    ...
                    <div className="tg-info">
                      <div className="lang-title">Global Group</div>
                      <div className="tg-url">https://twitter.com/BakedCakeBEP20</div>
                    </div>
                  </a>
                </div> */}
              </div>
